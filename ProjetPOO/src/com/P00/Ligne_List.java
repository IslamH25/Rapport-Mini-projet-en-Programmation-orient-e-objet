...
public class Ligne_List {
    ...
    public int Recherche_LN(String numero) {
        int i = 0;
        while (!this.LN.get(i).getNumero().equals(numero) && i < this.LN.size()) {
            i++;
        }
        return i;
    }
    ...
    public void Ajout_LN(String num,String m,int i,int nbrs,int n,String mrq
            , int ann,int numt, float kilo, String etat,int nums,String noms, String types) {
        Ligne L = new Ligne();
        Ajout_Ligne l = new Ajout_Ligne();
        System.out.print(l.getNum());
        L = L.Saisie(l.getNum(),l.getM(),l.getNbrs());
        this.LN.add(i, L);
    }
        ...
        for (int j = 0; j < this.LN.get(i).getST().size(); j++) {
            if (this.LN.get(i).getST().get(j).getType().equals(p)) {
                System.out.print(this.LN.get(i).getST().get(j).getNom() +
                        '(' + this.LN.get(i).getST().get(j).getType() + ')' + '\t');
            } else
                System.out.print(this.LN.get(i).getST().get(j).getNom() + '\t');
        }
    ...
    public void Remplissage_auto(){
        ...
        NA1.add(1,N2);
        Ligne L1=new Ligne("M001",ST1,6,TR1,MoyTransport.M,NA1);
        ...
        NA2.add(2,N5);
        Ligne L2=new Ligne("B005",ST2,4,TR2,MoyTransport.B,NA2);
        ...
        NA2.add(0,N6);
        Ligne L3=new Ligne("T004",ST1,5,TR3,MoyTransport.T,NA3);
        ...
        Ligne L4=new Ligne("TR007",ST4,8,TR4,MoyTransport.TR,NA4);
